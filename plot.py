...
ax.set_title("NMOS current-mirror output characteristic — SKY130, I$_{ref}$ = 10 µA, 1.8 V")
ax.set_xlim(0, 1.8); ax.set_ylim(0, 11)
ax.legend(loc="upper left", bbox_to_anchor=(0.015, 0.99), framealpha=0.95)
ax.grid(alpha=0.25)
...
ax.set_title("Output compliance: Sooch trades one bias device for ~0.39 V more swing + higher R$_{out}$")
ax.invert_yaxis()
